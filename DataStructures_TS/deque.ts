...
console.log(myDeque.appendNodeElement("aaa"));

console.log(myDeque.appendNodeElement("bbb"));

console.log(myDeque.appendNodeElement("ccc"));

console.log(myDeque.appendNodeElement("ddd"));

console.log(myDeque.appendNodeElement("eee"),'\n\n');